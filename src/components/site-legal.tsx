...
function PrivacyBody() {
  return (
    <>
      <p>
        This page describes what MergePDF does with what you give it, and what it
        does not do.
      </p>

      <h3>We don’t see your PDFs. Ever.</h3>
      <p>All PDF reading and writing happens locally on your device. Your documents are never uploaded to any server.</p>
      <p>Your PDFs are <strong>never uploaded to any server</strong>, never stored, and never transmitted across the network.</p>

      <h3>No accounts, no tracking identifiers</h3>
      <p>
        MergePDF does not require sign-up and does not use accounts. It sets no
      ...
      <ul>
        <li>The PDFs you choose to work with.</li>
      ...
      <p>
        ...
        disk by MergePDF itself beyond what you explicitly save.
      </p>

      <h3>Analytics</h3>
      <p>
        MergePDF includes no third-party analytics and no advertising trackers.
      ...
      <p>
        MergePDF is a general-purpose utility and does not knowingly collect
        data from anyone, including children.
      </p>

      <h3>Changes to this policy</h3>
      <p>
        If this ever changes, this page will be updated. Because the tool is built to run without a server, the promise that your PDFs stay on your device will not change.
      </p>

      <h3>Contact</h3>
      <p>
        MergePDF is open source. For questions about this policy, email{" "}
        <a
...
function TermsBody() {
  return (
    <>
      <p>
        By using MergePDF, you agree to these terms. They’re short on purpose.
      </p>

      <h3>The service</h3>
      <p>
        MergePDF is a free, browser-based tool for merging, splitting, and rearranging PDF pages. It is provided “as is” and “as available”,
      ...
      <p>
        You are responsible for the PDFs you use with the tool. Because the
      ...
      <ul>
        <li>Don’t use MergePDF for anything you don’t have the right to do.</li>
      ...
      <h3>Free and open</h3>
      <p>
        MergePDF is free to use. There are no paid tiers, no watermarks, and no
      ...
      <p>MergePDF is built on open-source libraries, including pdf-lib, and pdfjs-dist. Each is governed by its own license.</p>

      <h3>Changes</h3>
      <p>
        These terms may be updated from time to time. Continued use of
        MergePDF after a change constitutes acceptance of the updated terms.
      </p>
    </>
  );
}
