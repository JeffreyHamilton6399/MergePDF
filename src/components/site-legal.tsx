...
function PrivacyBody() {
  return (
    <>
      <p>
        Your privacy is the whole point of MergePDF. This page explains exactly
      ...
      <p>
        If this ever changes, this page will be updated. Because the tool is built to run without a server, the core promise — your PDFs stay on your device — will not change.
      </p>
